        ...
        <div className="SobreMi">
            ...
            <div className="contenido"> 
                <img src="/PedroSeñalando.png" alt="" />
                    <p>
                        ¡Hola! Mi nombre es <b>Pedro</b>, soy un desarrollador web
                        originario de San Andrés de Giles, Buenos Aires, Argentina.
                        Nací el 13 de septiembre de 1998 como el primer hijo de una
                        familia que me educó en valores, por los que siempre estaré
                        agradecido. Desde pequeño siempre he estado interesado en
                        aprender cosas nuevas.
                    </p>
                    <p>
                        Actualmente resido en la Ciudad Autónoma de Buenos Aires,
                        donde he estudiado y desarrollado mis habilidades como{" "}
                        <b>desarrollador web</b>. Estudié{" "}
                    ...
                    <p>
                        ...
                        <b>Tecnicatura en Danza</b> en la Universidad Nacional de
                        Arte. Me encanta la emoción de actuar y la belleza del
                    ...
                    <p>
                        ...
                        oportunidades. Me gusta trabajar en proyectos independientes
